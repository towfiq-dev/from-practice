  ...
  return (
    <div>
      <h1 className="text-4xl font-bold text-primary text-center">
        Congratulations! Your project is successfully ready
      </h1>
      {/* <form className='grid justify-center mt-15'>
      <label className='text-[18px] font-medium' htmlFor="">Name</label>
      <input className='border-2 border-black text-[17px] font-medium w-80 h-5 rounded py-5 px-2 ' type="text" name='name' id="" placeholder='Enter your name'/> <br />
